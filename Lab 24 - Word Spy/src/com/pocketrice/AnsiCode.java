...
public enum AnsiCode {
    ...
    // Allows for using AnsiCodes just as they were used when they were declared as static constants within the Class; allows for compat with previous projects (only need to import com.pocketrice.AnsiCode statically).
    @Override
